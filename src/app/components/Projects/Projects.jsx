const Projects = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-purple-r">Um pouco da minha experiencia</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-opacity-80">Meus trabalhos públicos abrangem diversas áreas, de tecnologia a desenvolvimento social. Busco impacto positivo e soluções criativas em cada projeto.</p>
    </div>
    ...
    <button class="flex mx-auto mt-16 text-white bg-purple-950 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg">Button</button>
  </div>
</section>
      </>
    );
