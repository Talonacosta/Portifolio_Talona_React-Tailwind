...
export default function Links() {
  ...
  return (
    <div>
      ...
      <p className="text-1xl text-zinc-900 my-4 text-center  ">
        Aqui estão alguns links importantes para me encontrar online.
      </p>
      <div id="links" className="max-w-[675px] mx-auto">
        <a
          className="link border-2 border-black rounded-lg rounded-10 text-lg font-roboto text-center block mx-10 my-3 p-2 text-decoration-none tap-highlight-transparent transition duration-300 bg-transparent"
